...
The deployed system may be seen here https://white-plant-0e13da003.4.azurestaticapps.net/, however at the time of viewing the API which transmits data will no longer be running due to privacy reasons, hence the graph displaying data will not be present.
